...
import com.aserbao.androidcustomcamera.blocks.mediaCodec.primary.EncodeAndMuxActivity;
...
public class MediaCodecActivity extends RVBaseActivity {
    ...
    public List<ClassBean> initData() {
        ...
        mClassBeans.add(new ClassBean("MediaCodec基本方法使用2",EncodeAndMuxActivity.class));
